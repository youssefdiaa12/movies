...
class MoreLikeThisMovieWidgetList extends StatefulWidget {
  ...
  MoreLikeThisMovieWidgetList({Key? key, this.recommendedMovie}) : super(key: key);

  @override
  State<MoreLikeThisMovieWidgetList> createState() => _MoreLikeThisMovieWidgetListState();
}

class _MoreLikeThisMovieWidgetListState extends State<MoreLikeThisMovieWidgetList> {
  MoviesList? movie;
